...
class NumberController extends GetxController {
  ...
  void loadFlashCards() {
    var savedFlashCards = numbeR.read<List>('flashCards') ?? [];
  ...
  void saveFlashCards() {
    numbeR.write('flashCards', allFlashCards.map((e) => e.toJson()).toList());
  }
  ...
  void selectRandomFlashCards() {
    ...
    print('Selected FlashCards: ${numbers.length}');
  }
